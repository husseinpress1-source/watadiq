  ...
  return (
    <div className="watad-live-page">
      ...
      <main className="live-main">
        <section className="live-hero" aria-labelledby="live-hero-title">
          <picture className="live-hero__art" aria-hidden="true">
            <source
              ...
              srcSet="/images/live/hero-desktop-1920.webp 1920w, /images/live/hero-desktop-3840.webp 3840w"
              sizes="100vw"
              type="image/webp"
            />
            <img
              src="/images/live/hero-mobile.webp"
              srcSet="/images/live/hero-mobile.webp 1080w, /images/live/hero-mobile-1440.webp 1440w"
              sizes="100vw"
              alt={t('live.heroImageAlt')}
              loading="eager"
              decoding="async"
              fetchPriority="high"
              width={1080}
        ...
        <section id="platforms" className="live-block" aria-labelledby="live-platforms-title">
